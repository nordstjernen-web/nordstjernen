...
static const char k_about_start_body[] =
    ...
    "<style>\n"
    "html, body { background:#0c1326; color:#e9eef7;"
    ...
    ".tagline { color:#8aa0c8; font-style: italic; margin: 0 0 1.6em 0;"
    " font-size: 1.0em; }\n"
    "form.search { margin: 0 auto 2.6em auto; display:flex; gap: 8px;"
    " max-width: 560px; }\n"
    "form.search input[type=text] { flex:1; padding: 12px 14px; font-size:1em;"
    " background:#172244; color:#e9eef7;"
    " border:1px solid #2b3a66; border-radius:6px; outline:none; }\n"
    "form.search input[type=text]:focus { border-color:#7ea3ff; }\n"
    "form.search button { padding: 12px 18px; font-size:1em;"
    " background:#3a63d0; color:white; border:0;"
    " border-radius:6px; cursor:pointer; }\n"
    "form.search button:hover { background:#4a73e0; }\n"
    ".tiles { display:grid; grid-template-columns: repeat(3, 1fr);"
    " gap: 12px; margin: 0 auto; max-width: 600px; }\n"
    ".tile { display:block; padding: 18px 10px; background:#172244;"
    " border:1px solid #2b3a66; border-radius:8px;"
    " color:#cfdcf6; text-decoration:none; }\n"
    ".tile:hover { background:#1f2c52; border-color:#3a63d0; color:#fff; }\n"
    ".tile .name { display:block; font-size:1.0em; font-weight:600; }\n"
    ".tile .host { display:block; color:#8aa0c8; font-size:0.85em;"
    " margin-top:3px; }\n"
    ".footer { color:#5a6a8a; font-size:0.85em; margin-top:3em; }\n"
    ".footer a { color:#8aa0c8; }\n"
    "</style></head>"
    "<body>"
    "<div class=\"wrap\">"
    ...
    " src=\"data:image/svg+xml;utf8,"
    "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96'>"
    "<circle cx='48' cy='48' r='46' fill='%23172244'"
    " stroke='%237ea3ff' stroke-width='2'/>"
    "<polygon points='48,10 52,44 86,48 52,52 48,86 44,52 10,48 44,44'"
    " fill='%23ffffff'/>"
    "<circle cx='48' cy='48' r='4' fill='%237ea3ff'/>"
    "</svg>\">"
