...
static const char k_about_start_body[] =
    ...
    " font-size: 1.05em; }\n"
    "form.search input { border: 0; background:#f4f6fb;"
    " padding: 10px 14px; font-size: 1.0em; }\n"
    "form.search button { border: 0; background:#e6e6e6;"
    " padding: 10px 18px; font-weight: 600; font-size: 1.0em; }\n"
